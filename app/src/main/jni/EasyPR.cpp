...
JNIEXPORT jstring JNICALL Java_com_example_tpsb_myprimg_PlateRecognizer_stringFromJNI(JNIEnv *env, jclass instance) {
    return env->NewStringUTF("车牌识别，初始化成功！");
}
...
JNIEXPORT jlong JNICALL Java_com_example_tpsb_myprimg_PlateRecognizer_initPR(JNIEnv *env, jclass instance, jstring svmpath, jstring annpath) {
...
JNIEXPORT jlong JNICALL Java_com_example_tpsb_myprimg_PlateRecognizer_uninitPR(JNIEnv *env, jclass instance, jlong recognizerPtr) {
...
JNIEXPORT jbyteArray JNICALL Java_com_example_tpsb_myprimg_PlateRecognizer_plateRecognize(JNIEnv *env, jclass instance, jlong recognizerPtr, jstring imgpath) {
    CPlateRecognize *pr = (CPlateRecognize *)recognizerPtr;
